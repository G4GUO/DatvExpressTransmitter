...
uint8_t gpoly[RS_LEN]={59,36,50,98,229,41,65,163,8,30,209,68,189,104,13,59};

#endif

uint8_t gf[G_SIZE];
uint8_t gmult_tab[G_SIZE][RS_LEN];
uint8_t l_shift[RS_LEN];
...
*/
inline uint8_t rs_round( uint8_t val )
{
    uint8_t sum = 0;
